...
let myImage = document.querySelector("img"); //<--- ERROR #1
...
buttonBtn.addEventListener("click", function() {
    ...
    myImage.src = "https://cdn.pixabay.com/photo/2017/02/20/18/03/cat-2083492_1280.jpg"; //<--- ERROR #2
});

// When the mouse is over the anchor tag, the img tag will be displayed and 
// the src (i.e., image to be displayed) will be updated.
anchorBtn.addEventListener("mouseover", function() { 
    myImage.style.display = 'block'; //<--- ERROR #3
...
// the src (i.e., image to be displayed) will be updated.
paragraphBtn.addEventListener("mouseout", function() { //<--- ERROR #4
    myImage.style.display = 'block';
